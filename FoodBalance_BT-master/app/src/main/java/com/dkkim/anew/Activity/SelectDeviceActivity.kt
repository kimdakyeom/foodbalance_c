...
import com.dkkim.anew.Util.ProgressDialog
...
class SelectDeviceActivity : AppCompatActivity() {
        ...
        override fun onReceive(context: Context?, intent: Intent) {
            ...
            when (action) {
                ...
                ACTION_DISCOVERY_FINISHED -> {
                    if (progressDialog?.isShowing == true) { progressDialog?.dismiss() } //로딩화면 보여주기
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progressDialog = ProgressDialog(this) //다이얼로그 선언

        progressDialog?.window!!.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT)) //백그라운를 투명하게
